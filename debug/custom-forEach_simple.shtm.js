...
if(_js_meth_c_forEach_3(n.body.list[3])){return true;}
ghy_shtm_tmp_out_str+="\r\n-str-\r\n"

if(_js_meth_c_forEach_4(n.body.list[5])){return true;}
ghy_shtm_tmp_out_str+="\r\n-end"
 }
...
if(_js_meth_c_forEach_2(n.body.list[0])){return true;}ghy_shtm_tmp_out_str+=""
