...
if(_js_meth_c_if_7()){return true;}ghy_shtm_tmp_out_str+=""
 }
...
let evalDoAfterBody = js_th_c_if_5.doAfterBody();
      ...
      var msg = js_th_c_if_5.getErrInfo();
      msg += e;
      ghy_shtm_tmp_out_str=msg;
      return true;
      }
...
let evalDoAfterBody = js_th_c_if_6.doAfterBody();
      ...
      var msg = js_th_c_if_6.getErrInfo();
      msg += e;
      ghy_shtm_tmp_out_str=msg;
      return true;
      }
...
js_th_c_if_7.setErrInfo("ERROR:  position:(7,0)\r\n   5|<c:if test=\"${test3}\">t5</c:if>\r\n   6|<c:if test=\"${\'xixihaha\'}\">t6</c:if>\r\n>> 7|<c:if test=\"${\'xixihaha\'.length>0}\">t7</c:if>   8|<c:if test=\"${\'xixihaha\'.length>0}\">t7</c:if>");
...
let evalDoAfterBody = js_th_c_if_7.doAfterBody();
      ...
      var msg = js_th_c_if_7.getErrInfo();
      msg += e;
      ghy_shtm_tmp_out_str=msg;
      return true;
      }
