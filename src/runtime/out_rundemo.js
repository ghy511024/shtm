...
str+=title;
str+="</h1>\r\n\r\n";
if(_js_meth_c_if_1(n.body.list[4])){return true;}
...
js_th_c_if_1.setPageContext(pageContext);js_th_c_if_1.setTest(if_test1);
...
js_th_c_if_2.setPageContext(pageContext);js_th_c_if_2.setTest(if_test1&&if_test2);
...
js_th_c_forEach_2.setPageContext(pageContext);js_th_c_forEach_2.setItems(item.data);js_th_c_forEach_2.setVar("li");
...
js_th_c_forEach_3.setPageContext(pageContext);js_th_c_forEach_3.setItems(maps);js_th_c_forEach_3.setVar("item");
...
js_th_c_forEach_4.setPageContext(pageContext);js_th_c_forEach_4.setItems(list2);js_th_c_forEach_4.setVar("item");
